...
const serverStats = {
  guildID: '505418627281846284',
  totalUsersID: '523491545727631373',
  memberCountID: '523491626870374400',
  botCountID: '523491720906801157'
};
...
bot.login("NTIzNDc3NDg4MTE0ODYwMDQz.DvaObQ.lAN3VAPLG37xb7OcBSVNZfDoHVM   ")
...
bot.on("guildMemberAdd", member => {
  ...
  member.guild.channels.find("id", "505418627281846290").send(`:white_check_mark: ${member.user.username} Est arrivé(e) ! Nice ! :p`)
...
if (message.content.startsWith(`<@523477488114860043> Tu commence doucement à me faire chier toi`))
    message.channel.send("Moi aussi je t'aime mon chou <3")
    if (message.content.startsWith(`<@523477488114860043> bon courage`))
...
if (message.content.startsWith( prefix + "roi")) {
 ...
 if(message.content === prefix + 'dev')
  ...
  .addField("Si tu lis ceci c'est pour en savoir plus sur mon développeur. Je vais tout te dire.", "Son pseudo discord est ℒ𝓪𝓻𝓪 ℱ𝒆𝓷𝓻𝓲𝓻#1084. Il est développeur depuis longtemps déjà. Il as déjà créée (avant de me créer moi) un bot musique, qui dois sans doutes être présent actuellement sur le serveur ou tu te situe (dans le cas contraire, désolée :/) essaie donc de faire '+help music' tu verras !")
...
if (message.content.startsWith("T'est belle <@523477488114860043>"))
